...
void TgAppleView::paintEvent(QPaintEvent *pEvent)
{
	...
	const QPixmap bg = m_pResources->pixmap("APPLE_BACKGROUND");
	...
	const QPixmap appleGood = m_pResources->pixmap("APPLE_NORMAL");
	const QPixmap appleBad = m_pResources->pixmap("APPLE_BAD");
	...
	const QPixmap basket = m_pResources->pixmap("APPLE_BASKET");
	...
	const QPixmap small = m_pResources->pixmap("APPLE_SMALL");
